  ...
  return (
    <main style={{ maxWidth: "880px", margin: "0 auto", padding: "50px 20px 80px" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: "40px" }}>
        ...
        <h1 style={{ fontSize: "clamp(24px, 4.5vw, 40px)", margin: 0, color: "#F5F2E9", fontWeight: 900 }}>
          CHÀO MỪNG {name.toUpperCase()} ĐẾN VỚI IDENTITY DESIGN™!
        </h1>
        ...
        <div style={{ display: "grid", gap: "20px" }}>
          ...
          <div style={{ background: "#171A18", borderLeft: "4px solid #D96732", padding: "20px", borderRadius: "10px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "8px" }}>
              ...
              <strong style={{ color: "#FAD08B", fontSize: "17px" }}>BƯỚC 2: TẢI BỘ ACTION-SHEET & NHẬT KÝ 21 NGÀY</strong>
            </div>
            <p style={{ color: "#D5DFDB", fontSize: "15px", margin: 0, lineHeight: 1.6 }}>
          ...
          <div style={{ background: "#171A18", borderLeft: "4px solid #D96732", padding: "20px", borderRadius: "10px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "8px" }}>
              ...
              <strong style={{ color: "#FAD08B", fontSize: "17px" }}>BƯỚC 3: XEM VIDEO KHỞI ĐỘNG HỌC PHẦN 1</strong>
            </div>
            <p style={{ color: "#D5DFDB", fontSize: "15px", margin: 0, lineHeight: 1.6 }}>
